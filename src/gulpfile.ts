...
var src = {
    ...
    lib_web: ['lib/misc-web.ts', 'lib/util.ts', 'lib/fs-api.ts', 'lib/fs-plus.ts', 'lib/channel.ts', 'lib/sftp-enums.ts', 'lib/sftp-packet-web.ts', 'lib/sftp-misc.ts', 'lib/sftp-client.ts', 'lib/sftp-web.ts'],
    pkg: ['package.json'],
};
